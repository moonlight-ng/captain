...
export function SearchRadarIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <circle cx="12" cy="12" r="2.2" />
      <path d="M12 5.5a6.5 6.5 0 0 1 6.5 6.5M12 2a10 10 0 0 1 10 10" />
      <path d="M12 5.5a6.5 6.5 0 0 0-6.5 6.5M12 2a10 10 0 0 0-10 10" opacity=".35" />
    </svg>
  );
}
...
export function TripsIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M4 18h16M7 18V8.5a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2V18" />
