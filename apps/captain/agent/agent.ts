...
export default defineAgent({
  description: "Captain is a public travel agent that creates Trips, tracks flight prices in USD or GBP via Duffel inventory, discovers the strongest options, and explains important changes.",
  model: defineDynamic({
