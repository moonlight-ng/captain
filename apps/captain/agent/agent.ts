...
export default defineAgent({
  description: "Captain is a public travel agent that plans uncertain itineraries and dates, creates trips, and checks and tracks verified flight prices in USD or GBP.",
  model: defineDynamic({
